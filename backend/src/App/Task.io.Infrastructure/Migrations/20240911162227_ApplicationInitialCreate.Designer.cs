...
namespace Task.io.Infrastructure.Migrations
{
    ...
    [Migration("20240911162227_ApplicationInitialCreate")]
                    ...
                    b.ToTable("tasks", "task.io-app", t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_task_created_at_datetime_smaller_than_update_at", "created_at < update_at");
                    ...
                    b.ToTable("users", "task.io-app", t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_user_created_at_datetime_smaller_than_update_at", "created_at < update_at");
