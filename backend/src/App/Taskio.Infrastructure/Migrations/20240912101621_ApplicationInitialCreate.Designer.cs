...
namespace Taskio.Infrastructure.Migrations
{
    ...
    [Migration("20240912101621_ApplicationInitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taskio.Domain.Entities.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Taskio.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Taskio.Domain.Entities.Task", b =>
                {
                    b.HasOne("Taskio.Domain.Entities.User", "User")
                        .WithMany("Tasks")
